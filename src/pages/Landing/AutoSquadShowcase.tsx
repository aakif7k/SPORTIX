  ...
  return (
    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        >
          <p className="font-mono text-[11px] text-[#CCFF00] uppercase tracking-[4px] mb-4">
          ...
          <p className="font-mono text-[14px] text-[#888] mt-4 max-w-md mx-auto leading-relaxed">
            Tell us your sport and skill level. Pulse Engine finds the perfect
            11.
          </p>
        </motion.div>
        ...
        {/* Terminal Card */}
        <motion.div
          className="max-w-[600px] mx-auto rounded-2xl overflow-hidden mb-8"
          style={{
        ...
        >
          ...
          <div
            ...
            style={{ borderColor: "rgba(204,255,0,0.08)" }}
          >
            ...
            <div className="flex items-center gap-2 ml-2">
              ...
              />
              <span className="font-mono text-[11px] text-[#CCFF00] uppercase tracking-widest">
                Pulse Engine Active
              </span>
            </div>
          </div>
          ...
          <div className="p-6 min-h-[200px] font-mono text-[13px]">
            {TERMINAL_LINES.map((line, i) => (
              <div
                ...
                style={{
                  opacity: i < activeLines ? 1 : 0,
                  color: i === activeLines - 1 ? "#CCFF00" : "#3A3A3A",
                }}
              >
                {line}
                {i === activeLines - 1 && (
          ...
          <div className="px-6 pb-5">
            <div
              ...
              style={{ background: "#1A2200" }}
            >
              <div
                className="h-full rounded-full transition-all duration-100"
                style={{
                  width: `${progress}%`,
                  background: "linear-gradient(90deg, #CCFF00aa, #CCFF00)",
                  boxShadow: "0 0 8px #CCFF0080",
                }}
              />
            </div>
          </div>
              ...
              >
                ...
                <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-none mb-5">
                  {PLAYERS.map((p, i) => (
                    ...
                    >
                      <div
                        className="w-12 h-12 rounded-full flex items-center justify-center font-['Barlow_Condensed'] font-bold text-sm"
                        style={{
                          background: p.color,
                          border: "1px solid rgba(204,255,0,0.25)",
                          color: "#CCFF00",
                      ...
                      <div className="text-center">
                        <p className="font-mono text-[9px] text-[#888] truncate max-w-[60px]">
                          {p.name.split(" ")[0]}
                        </p>
                        <p className="font-mono text-[9px] text-[#CCFF00]">
                          {p.pos}
                        </p>
        ...
        >
          {PILLS.map((pill) => (
            <div
              key={pill}
              className="px-4 py-2 rounded-full font-mono text-[12px]"
              style={{
