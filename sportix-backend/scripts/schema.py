...
COLLECTIONS: list[Collection] = [
    ...
    Collection(
        ...
        attrs=[
            ...
            S("content", 500, required=True), D("created_at", required=True),
        ],
        indexes=[KEY("post_id"), DESC("created_at")],
    ),
    Collection(
    ...
    Collection(
        ...
        attrs=[
            ...
            S("city", 80),
            F("lat"), F("lng"),
            D("starts_at", required=True), D("ends_at"),
            I("max_participants", required=True, default=10), I("current_participants", default=0),
    ...
    Collection(
        ...
        attrs=[
            ...
            S("role", 40), ID_("crew_id"), D("joined_at", required=True),
        ],
